...
Table \ref{PC90} shows a comparison of the PC90 estimates by the 3 different methods utilised so far. If we perform 2-way ANOVA between the 3 PC90 estimates by subject and method i.e.
$$\mathrm{PC}90_{ij}=subject_{i}+method_{j}+\epsilon_{ij}\quad\quad\epsilon\sim N(0,\sigma^{2})$$ 
we obtain the residuals shown in Figure \ref
\begin{table}
\centering
